...
if __name__ == '__main__':
    ...
    categorytest = "nlin"
    oDir = "/Users/huihui/Data/wiki/ese_out/arxiv/"
    outputfile = open(oDir+categorytest+"s","w")
    
    scraper = Scraper(category=categorytest, date_from='2018-01-01',date_until='2019-04-01')
